                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="w-full">
                            ...
                            <td
                                ...
                                <button wire:click="click" {{ $request->status ? '' : 'disabled' }} class="{{
                                       $request->status ? 'text-orange-600 hover:text-orange-800' : 'text-gray-400 cursor-not-allowed'  }}">Print</button>
    ...
    "
        ...
        <div class="fixed left-1/2 top-10 w-full max-w-lg -translate-x-1/2 rounded bg-white p-4 shadow-lg sm:p-9">
            ...
            <div class="sm:flex justify-between">
                ...
                <button @click="$dispatch('close-modal')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x-icon lucide-x">
                        <path d="M18 6 6 18" />
                        <path d="m6 6 12 12" />
                    </svg></button>
            </div>
            ...
            <form wire:submit.prevent="update" class="mt-4 space-y-2">
                <div class="sm:flex items-center gap-3">
                    <div>
                        ...
                        <x-text-input id="ris" type="text" wire:model="withdrawForm.ris" class="w-full" required autofocus />
                        <x-input-error :messages="$errors->get('withdrawForm.ris')" class="mt-2" />
                    </div>
                    <div>
                        <x-input-label for="item_quantity" :value="__('Item Quantity')" />
                        <x-text-input id="item_quantity" type="number" wire:model="requested_quantity"
                ...
                <div class="sm:grid grid-cols-2 items-center gap-3">
                    <div class="w-full">
                        ...
                        <select wire:model.live.debounce.300ms="approver_id" id="approved_by" required
                ...
                <div>
                    ...
                    <x-text-input id="remarks" type="text" wire:model="withdrawForm.remarks" class="w-full" required autofocus />
