                ...
                <div class="px-4 py-3 sm:flex sm:items-center sm:justify-between">
                    ...
                    @if (auth()->user()->hasAnyRole(['super-admin', 'admin']))
                        <a href="{{ route('request-list') }}"
                            ...
                            <!-- Label Text -->
                            <span class="hidden text-sm sm:block">Request List</span>
                ...
                <form wire:submit.prevent="editStock" class="mt-4 space-y-2">
                    ...
                    <div class="sm:flex sm:items-center sm:gap-x-2">
                        <div>
                            ...
                            <x-text-input id="item_quantity" type="number" v wire:model="stockForm.item_quantity"
